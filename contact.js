...
_g.contract.address = _g.state.isDebugging? 'n1kgQeum3BTLJAsqn26DHDQAdyWSd1dBXWA': 'n1kgQeum3BTLJAsqn26DHDQAdyWSd1dBXWA'; 
// wallet
...
function addAchievement () {
  ...
  console.log(JSON.stringify([achilist]));
  submitMethod('0', 'addAchievement', JSON.stringify([achilist]), 'comment evaluate');
}

function uploadAchievementforUser () {
  var user = {};
  user.ach_id = 1;
  user.screenshoturl = 1;
  user.timestamp = Date.parse(new Date());
  user.point = 10;
  console.log(JSON.stringify([user]));
  submitMethod('0', 'uploadAchievementforUser', JSON.stringify([user]), 'comment evaluate');
}
